...
The explicit post-ledger charges above total **4.0 h estimated**, but this is not the same thing as saying 16.0 h remain because the pre-ledger historical block is unresolved.
