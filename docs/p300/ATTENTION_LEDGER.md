...
| 2026-09-13 | Phase-A causal implementation: Bitvavo target alignment, direct-USDC collector core, independent-episode preregistration and immutable evidence integrity | 0.5 h | ESTIMATED |
| 2026-09-13 | Phase-A horizon evidence: causal as-of snapshots, horizon recorder v2, semantic episode-envelope gating and adversarial CI review | 0.5 h | ESTIMATED |
...
The explicit post-ledger charges above total **6.0 h estimated**, but this is not the same thing as saying 14.0 h remain because the pre-ledger historical block is unresolved.
