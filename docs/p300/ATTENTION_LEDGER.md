...
The explicit post-ledger charges above total **5.5 h estimated**, but this is not the same thing as saying 14.5 h remain because the pre-ledger historical block is unresolved.
